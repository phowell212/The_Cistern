...
# Speeds
CAMERA_SPEED = 0.9
PLAYER_MOVEMENT_SPEED = 1.15
PLAYER_RUN_SPEED_MODIFIER = 1.8
SLASH_SPEED_MODIFIER = 0.15
SLASH_CHARGE_SPEED_MODIFIER = 0.8
SWORDSLASH_PROJECTILE_SPEED = 2.4
FLAMESLASH_PROJECTILE_SPEED = SWORDSLASH_PROJECTILE_SPEED * bosses_to_spawn
MONSTER_MOVEMENT_SPEED = 0.9
...
FLAMESLASH_SCALING = 0.5 * bosses_to_spawn
HEART_SCALING = 0.1
BOSS_SCALING = 0.35
